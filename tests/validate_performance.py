...
BASELINES = {
    ...
    "hybrid": {
        "total_pps": 0.2,    # total wall-clock
        "mover_pps": 0.03,   # isolated particle mover
        "solver_pps": 0.048, # explicit hybrid field advance is cheaper
        "speedup": 1.4,      # 2-core scaling floor
    },
    "pt": {
