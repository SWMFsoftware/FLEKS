...
// Narrow per-particle state handed to a particle-seeding IC. The IC may read
// the particle's position / index and modify its bulk velocity and
// macroparticle weight. It never touches Particles internals directly.
...
public:
  ...
  // uMax / upwind-velocity were promoted to #FIXEDUMAX / #UPWINDB
  // fixedUpwindVel options and the override_umax()/bypass_limiter() hooks
  // removed.
