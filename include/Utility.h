...
// draws j in [0, i - 1] (i.e. element i never stays in place and element 1
// always swaps with 0). We preserve floor(rd() * i) here to maintain bitwise
// compatibility with existing SWMF test regression references (e.g. OH-PT
// test20/test22).
