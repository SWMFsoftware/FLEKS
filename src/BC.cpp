...
//
// `Legacy::silent` entries are documented aliases (e.g. `open`, which
// PARAM.XML has always listed).  `Legacy::deprecated` entries are spellings
// the old shared enum accepted but that belong to the *other* domain; they
// are mapped to the nearest sensible value and reported, so existing input
// files keep running while the mistake is made visible.
//==========================================================================
