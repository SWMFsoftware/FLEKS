...
std::unique_ptr<InitialCondition> ICRegistry::create(const std::string& name) const {
...
amrex::MultiFab& PicICFields::node_E(int iLev) { return pic_->get_node_E(iLev); }

amrex::MultiFab& PicICFields::node_B(int iLev) { return pic_->get_node_B(iLev); }
